...
const func: DeployFunction = async ({
  ...
  const liquidityPoolToWantTokenToSlippages = [
    ...
    // { liquidityPool: SUSHI_WETH_LP, wantToken: ethereumTokens.WRAPPED_TOKENS.WETH, slippage: "150" },
    ...
    // { liquidityPool: MANA_WETH_LP, wantToken: MANA, slippage: "150" },
    ...
    // { liquidityPool: ALCX_WETH_LP, wantToken: ALCX, slippage: "150" },
    ...
    // { liquidityPool: CVX_WETH_LP, wantToken: ethereumTokens.WRAPPED_TOKENS.WETH, slippage: "200" },
