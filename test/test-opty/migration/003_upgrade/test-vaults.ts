...
export const ethereumTestVaults: {
  ...
  [`${ethereumTokens.PLAIN_TOKENS.USDC}`]: {
    "0x6d8bfdb4c4975bb086fc9027e48d5775f609ff88": {
      ...
      oldName: "OptyFi USDC Earn Vault",
      oldSymbol: "opUSDC-Earn",
      oldAbi: VaultV5__factory.abi,
  ...
  [`${ethereumTokens.WRAPPED_TOKENS.WETH}`]: {
    "0xFf2fbd9Fbc6d03BAA77cf97A3D5671bEA183b9a8": {
      ...
      oldName: "OptyFi WETH Earn Vault",
      oldSymbol: "opWETH-Earn",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xF980ea5758f71F418909688b6448B41ACb5522E9",
      ...
      hasStrategy: true,
      revision: BigNumber.from("5"),
      newName: "OptyFi WETH Earn Vault",
      newSymbol: "opWETH-Earn",
    },
    "0x104D929F91227B8E4dA89CDee26e76d9c27bB347": {
      underlyingTokenSymbol: "WETH",
      oldName: "OptyFi WETH Invest Vault",
      oldSymbol: "opWETH-Invst",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      riskProfileCode: BigNumber.from(2),
      hasStrategy: true,
    ...
    "0x5ea8e0F538e1bBd66DB65f2a683127b6d32F0126": {
      underlyingTokenSymbol: "WETH",
      oldName: "OptyFi WETH Save Vault",
      oldSymbol: "opWETH-Save",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      testAccount: "0x0395D2EDB7069d135F2f868c063E17F08dA8960d",
      testBlockNumber: BigNumber.from("15626727"),
      riskProfileCode: BigNumber.from(0),
      hasStrategy: false,
      revision: BigNumber.from("5"),
  ...
  "0x98585dFc8d9e7D48F0b1aE47ce33332CF4237D96": {
    "0xF10aF2cf774B40bd4411fDF91d7C22003B46a130": {
      underlyingTokenSymbol: "NEWO",
      oldName: "OptyFi NEWO Invest Vault",
      oldSymbol: "opNEWO-Invst",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      testAccount: "0x6bd60f089B6E8BA75c409a54CDea34AA511277f6",
  ...
  [`${ethereumTokens.REWARD_TOKENS.AAVE}`]: {
    "0xd610c0CcE9792321BfEd3c2f31dceA6784c84F19": {
      ...
      oldName: "OptyFi AAVE Invest Vault",
      oldSymbol: "opAAVE-Invst",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      testAccount: "0x6bd60f089B6E8BA75c409a54CDea34AA511277f6",
  ...
  "0x4d224452801ACEd8B2F0aebE155379bb5D594381": {
    "0x02303CbAc47bc9B7a1FF25d456C3A7F079a09ebc": {
      underlyingTokenSymbol: "APE",
      oldName: "OptyFi APE Invest Vault",
      oldSymbol: "opAPE-Invst",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      riskProfileCode: BigNumber.from(2),
      hasStrategy: false,
  ...
  "0x0F5D2fB29fb7d3CFeE444a200298f468908cC942": {
    "0x15e98DD3e9aA220c559E4f020243736427420F25": {
      ...
      oldName: "OptyFi MANA Invest Vault",
      oldSymbol: "opMANA-Invst",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      riskProfileCode: BigNumber.from(2),
      hasStrategy: false,
  ...
  [`${ethereumTokens.REWARD_TOKENS.SUSHI}`]: {
    "0x4100488bfDA712538a078bC614f85534C127e780": {
      ...
      oldName: "OptyFi SUSHI Invest Vault",
      oldSymbol: "opSUSHI-Invst",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      riskProfileCode: BigNumber.from(2),
      hasStrategy: false,
  ...
  [`${ethereumTokens.PLAIN_TOKENS.LINK}`]: {
    "0x3a13eaa0755FA168854E3BF3a9F2a40b42cAdEA3": {
      ...
      oldName: "OptyFi LINK Invest Vault",
      oldSymbol: "opLINK-Invst",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      riskProfileCode: BigNumber.from(2),
      hasStrategy: false,
  ...
  [`${ethereumTokens.PLAIN_TOKENS.DAI}`]: {
    "0x71B48a3683D29Fd0a86AE19dDCDF4F52F5f2699e": {
      ...
      oldName: "OptyFi DAI Save Vault",
      oldSymbol: "opDAI-Save",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      testAccount: "0x6bd60f089B6E8BA75c409a54CDea34AA511277f6",
  ...
  [`${ethereumTokens.PLAIN_TOKENS.USDT}`]: {
    "0xB63cfC06A509C71AE8a198b456eb9b63f4947A8B": {
      ...
      oldName: "OptyFi USDT Save Vault",
      oldSymbol: "opUSDT-Save",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      testAccount: "0x6bd60f089B6E8BA75c409a54CDea34AA511277f6",
  ...
  [`${ethereumTokens.BTC_TOKENS.WBTC}`]: {
    "0x41a909f773A42F7a99F69B9E847056a79caCa159": {
      ...
      oldName: "OptyFi WBTC Save Vault",
      oldSymbol: "opWBTC-Save",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      testAccount: "0x6bd60f089B6E8BA75c409a54CDea34AA511277f6",
    ...
    "0x9e002EaDaAE317B7ab2be3ddD6b2F67252f348a8": {
      underlyingTokenSymbol: "WBTC",
      oldName: "OptyFi WBTC Earn Vault",
      oldSymbol: "opWBTC-Earn",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      testAccount: "0x6bd60f089B6E8BA75c409a54CDea34AA511277f6",
  ...
  [`${ethereumTokens.WRAPPED_TOKENS.THREE_CRV}`]: {
    "0x9E8262534fAeF7cBB7E1AfDa483829246a0eB963": {
      underlyingTokenSymbol: "USD3",
      oldName: "OptyFi USD3 Earn Vault",
      oldSymbol: "opUSD3-Earn",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0xAE27743Fa2862976CF9aa0754Fb191F7E8a246d4",
      testAccount: "0x6bd60f089B6E8BA75c409a54CDea34AA511277f6",
...
export const polygonTestVaults: {
  ...
  [`${polygonTokens.USDC}`]: {
    "0x7FeA9Dc468855B999389E396BdB1e3EbF6d19E83": {
      ...
      oldSymbol: "opUSDC-Earn",
      oldAbi: VaultV5__factory.abi,
      proxyAdmin: "0x013C437FB60327364eCd822022029c822CA8C46B",
