...
async function main() {
  ...
  const opUSDCEarn = <VaultV6>await ethers.getContractAt(VaultV6__factory.abi, opUSDCEarnOldAddress);
  const opWETHEarn = <VaultV6>await ethers.getContractAt(VaultV6__factory.abi, opWETHEarnOldAddress);
