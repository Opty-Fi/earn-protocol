...
const func: DeployFunction = async ({
  ...
  const artifact = await deployments.getArtifact("BeefyFinanceAdapter");
  ...
  const result = await deploy("BeefyFinanceAdapter", {
    ...
    if (result.newlyDeployed) {
      ...
      if (networkName === "tenderly") {
        await tenderly.verify({
          name: "BeefyFinanceAdapter",
          address: beefyFinanceAdapter.address,
...
export default func;
func.tags = ["PolygonBeefyFinanceAdapter"];
