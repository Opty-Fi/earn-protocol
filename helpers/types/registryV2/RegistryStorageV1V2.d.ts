...
interface RegistryStorageV1V2Interface extends ethers.utils.Interface {
  functions: {
...
export class RegistryStorageV1V2 extends BaseContract {
  ...
  interface: RegistryStorageV1V2Interface;
