...
interface IRegistryV2Interface extends ethers.utils.Interface {
  functions: {
...
export class IRegistryV2 extends BaseContract {
  ...
  interface: IRegistryV2Interface;
  ...
  functions: {
    ...
    getSwapPoolToAdapter(_pool: string, overrides?: CallOverrides): Promise<[string] & { _adapter: string }>;
