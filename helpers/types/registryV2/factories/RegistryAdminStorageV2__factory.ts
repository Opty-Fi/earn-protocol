...
import type { RegistryAdminStorageV2, RegistryAdminStorageV2Interface } from "../RegistryAdminStorageV2";
...
export class RegistryAdminStorageV2__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<RegistryAdminStorageV2> {
    return super.deploy(overrides || {}) as Promise<RegistryAdminStorageV2>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): RegistryAdminStorageV2 {
    return super.attach(address) as RegistryAdminStorageV2;
  }
  connect(signer: Signer): RegistryAdminStorageV2__factory {
    return super.connect(signer) as RegistryAdminStorageV2__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): RegistryAdminStorageV2Interface {
    return new utils.Interface(_abi) as RegistryAdminStorageV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): RegistryAdminStorageV2 {
    return new Contract(address, _abi, signerOrProvider) as RegistryAdminStorageV2;
  }
}
