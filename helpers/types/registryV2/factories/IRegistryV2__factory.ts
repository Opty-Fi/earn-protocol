...
import type { IRegistryV2, IRegistryV2Interface } from "../IRegistryV2";
...
export class IRegistryV2__factory {
  static readonly abi = _abi;
  static createInterface(): IRegistryV2Interface {
    return new utils.Interface(_abi) as IRegistryV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IRegistryV2 {
    return new Contract(address, _abi, signerOrProvider) as IRegistryV2;
  }
}
