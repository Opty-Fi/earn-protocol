...
import type { RegistryStorageV1V2, RegistryStorageV1V2Interface } from "../RegistryStorageV1V2";
...
export class RegistryStorageV1V2__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<RegistryStorageV1V2> {
    return super.deploy(overrides || {}) as Promise<RegistryStorageV1V2>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): RegistryStorageV1V2 {
    return super.attach(address) as RegistryStorageV1V2;
  }
  connect(signer: Signer): RegistryStorageV1V2__factory {
    return super.connect(signer) as RegistryStorageV1V2__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): RegistryStorageV1V2Interface {
    return new utils.Interface(_abi) as RegistryStorageV1V2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): RegistryStorageV1V2 {
    return new Contract(address, _abi, signerOrProvider) as RegistryStorageV1V2;
  }
}
