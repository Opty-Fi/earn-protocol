...
import type { VaultStorageV2V4, VaultStorageV2V4Interface } from "../VaultStorageV2V4";
...
export class VaultStorageV2V4__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<VaultStorageV2V4> {
    return super.deploy(overrides || {}) as Promise<VaultStorageV2V4>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): VaultStorageV2V4 {
    return super.attach(address) as VaultStorageV2V4;
  }
  connect(signer: Signer): VaultStorageV2V4__factory {
    return super.connect(signer) as VaultStorageV2V4__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VaultStorageV2V4Interface {
    return new utils.Interface(_abi) as VaultStorageV2V4Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VaultStorageV2V4 {
    return new Contract(address, _abi, signerOrProvider) as VaultStorageV2V4;
  }
}
