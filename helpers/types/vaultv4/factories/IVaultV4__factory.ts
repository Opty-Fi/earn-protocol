...
import type { IVaultV4, IVaultV4Interface } from "../IVaultV4";
...
export class IVaultV4__factory {
  static readonly abi = _abi;
  static createInterface(): IVaultV4Interface {
    return new utils.Interface(_abi) as IVaultV4Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IVaultV4 {
    return new Contract(address, _abi, signerOrProvider) as IVaultV4;
  }
}
