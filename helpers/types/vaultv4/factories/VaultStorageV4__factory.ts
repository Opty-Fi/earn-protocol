...
import type { VaultStorageV4, VaultStorageV4Interface } from "../VaultStorageV4";
...
export class VaultStorageV4__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<VaultStorageV4> {
    return super.deploy(overrides || {}) as Promise<VaultStorageV4>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): VaultStorageV4 {
    return super.attach(address) as VaultStorageV4;
  }
  connect(signer: Signer): VaultStorageV4__factory {
    return super.connect(signer) as VaultStorageV4__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VaultStorageV4Interface {
    return new utils.Interface(_abi) as VaultStorageV4Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VaultStorageV4 {
    return new Contract(address, _abi, signerOrProvider) as VaultStorageV4;
  }
}
