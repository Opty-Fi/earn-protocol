...
interface VaultStorageV2V4Interface extends ethers.utils.Interface {
  functions: {
...
export class VaultStorageV2V4 extends BaseContract {
  ...
  interface: VaultStorageV2V4Interface;
