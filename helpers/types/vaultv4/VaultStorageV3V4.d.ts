...
interface VaultStorageV3V4Interface extends ethers.utils.Interface {
  functions: {
...
export class VaultStorageV3V4 extends BaseContract {
  ...
  interface: VaultStorageV3V4Interface;
