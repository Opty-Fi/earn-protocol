...
import type { IVaultV3, IVaultV3Interface } from "../IVaultV3";
...
export class IVaultV3__factory {
  static readonly abi = _abi;
  static createInterface(): IVaultV3Interface {
    return new utils.Interface(_abi) as IVaultV3Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IVaultV3 {
    return new Contract(address, _abi, signerOrProvider) as IVaultV3;
  }
}
