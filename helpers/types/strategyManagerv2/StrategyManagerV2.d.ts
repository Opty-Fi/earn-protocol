...
interface StrategyManagerV2Interface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [{ pool: string; outputToken: string; isSwap: boolean }[], string],
  ): string;
  encodeFunctionData(
    functionFragment: "getLastStrategyStepBalanceLP",
    values: [{ pool: string; outputToken: string; isSwap: boolean }[], string, string, string],
  ): string;
  encodeFunctionData(
    functionFragment: "getOraSomeValueLP",
    values: [{ pool: string; outputToken: string; isSwap: boolean }[], string, string, BigNumberish],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [
      { pool: string; outputToken: string; isSwap: boolean }[],
      {
...
export class StrategyManagerV2 extends BaseContract {
  ...
  interface: StrategyManagerV2Interface;
  ...
  functions: {
    ...
    getDepositInternalTransactionCount(
      _strategySteps: { pool: string; outputToken: string; isSwap: boolean }[],
      _registryContract: string,
      overrides?: CallOverrides,
    ): Promise<[BigNumber]>;
