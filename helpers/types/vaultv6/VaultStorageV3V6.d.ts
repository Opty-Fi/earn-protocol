...
interface VaultStorageV3V6Interface extends ethers.utils.Interface {
  functions: {
...
export class VaultStorageV3V6 extends BaseContract {
  ...
  interface: VaultStorageV3V6Interface;
