...
interface VaultV6Interface extends ethers.utils.Interface {
  functions: {
    ...
    "userDepositVault(address,uint256,bytes,bytes32[])": FunctionFragment;
    "userWithdrawPermitted(address,uint256,bytes32[])": FunctionFragment;
    "userWithdrawVault(address,uint256,bytes32[])": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [{ pool: string; outputToken: string; isSwap: boolean }[]],
  ): string;
  ...
  encodeFunctionData(functionFragment: "userWithdrawVault", values: [string, BigNumberish, BytesLike[]]): string;
...
export class VaultV6 extends BaseContract {
