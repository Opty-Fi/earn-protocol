...
import type { VaultStorageV3V6, VaultStorageV3V6Interface } from "../VaultStorageV3V6";
...
export class VaultStorageV3V6__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<VaultStorageV3V6> {
    return super.deploy(overrides || {}) as Promise<VaultStorageV3V6>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): VaultStorageV3V6 {
    return super.attach(address) as VaultStorageV3V6;
  }
  connect(signer: Signer): VaultStorageV3V6__factory {
    return super.connect(signer) as VaultStorageV3V6__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VaultStorageV3V6Interface {
    return new utils.Interface(_abi) as VaultStorageV3V6Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VaultStorageV3V6 {
    return new Contract(address, _abi, signerOrProvider) as VaultStorageV3V6;
  }
}
