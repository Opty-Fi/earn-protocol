...
import type { VaultStorageV2V6, VaultStorageV2V6Interface } from "../VaultStorageV2V6";
...
export class VaultStorageV2V6__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<VaultStorageV2V6> {
    return super.deploy(overrides || {}) as Promise<VaultStorageV2V6>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): VaultStorageV2V6 {
    return super.attach(address) as VaultStorageV2V6;
  }
  connect(signer: Signer): VaultStorageV2V6__factory {
    return super.connect(signer) as VaultStorageV2V6__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VaultStorageV2V6Interface {
    return new utils.Interface(_abi) as VaultStorageV2V6Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VaultStorageV2V6 {
    return new Contract(address, _abi, signerOrProvider) as VaultStorageV2V6;
  }
}
