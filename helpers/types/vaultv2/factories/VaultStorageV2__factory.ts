...
import type { VaultStorageV2, VaultStorageV2Interface } from "../VaultStorageV2";
...
export class VaultStorageV2__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<VaultStorageV2> {
    return super.deploy(overrides || {}) as Promise<VaultStorageV2>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): VaultStorageV2 {
    return super.attach(address) as VaultStorageV2;
  }
  connect(signer: Signer): VaultStorageV2__factory {
    return super.connect(signer) as VaultStorageV2__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VaultStorageV2Interface {
    return new utils.Interface(_abi) as VaultStorageV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VaultStorageV2 {
    return new Contract(address, _abi, signerOrProvider) as VaultStorageV2;
  }
}
