...
interface RegistryAdminStorageV1Interface extends ethers.utils.Interface {
  functions: {
...
export class RegistryAdminStorageV1 extends BaseContract {
  ...
  interface: RegistryAdminStorageV1Interface;
