...
interface RegistryStorageV1Interface extends ethers.utils.Interface {
  functions: {
...
export class RegistryStorageV1 extends BaseContract {
  ...
  interface: RegistryStorageV1Interface;
