...
interface RegistryProxyV1Interface extends ethers.utils.Interface {
  functions: {
    "acceptGovernance()": FunctionFragment;
    "acceptImplementation()": FunctionFragment;
    "aprOracle()": FunctionFragment;
    "creditPools(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "creditPools", values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: "creditPools", data: BytesLike): Result;
  ...
  events: {
    ...
    "LogCreditPool(address,bool,address)": EventFragment;
    ...
    "LogRateCreditPool(address,uint8,address)": EventFragment;
    ...
    "NewPendingGovernance(address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "LogCreditPool"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "LogRateCreditPool"): EventFragment;
...
export type LogCreditPoolEvent = TypedEvent<
...
export type LogRateCreditPoolEvent = TypedEvent<
...
export type NewGovernanceEvent = TypedEvent<[string, string] & { oldGovernance: string; newGovernance: string }>;
...
export type NewPendingGovernanceEvent = TypedEvent<
  [string, string] & {
    oldPendingGovernance: string;
    newPendingGovernance: string;
  }
>;
...
export class RegistryProxyV1 extends BaseContract {
  ...
  interface: RegistryProxyV1Interface;
  ...
  callStatic: {
    acceptGovernance(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setPendingGovernance(newPendingGovernance: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "NewGovernance(address,address)"(
      oldGovernance?: null,
      newGovernance?: null,
    ): TypedEventFilter<[string, string], { oldGovernance: string; newGovernance: string }>;
    ...
    "NewPendingGovernance(address,address)"(
      oldPendingGovernance?: null,
      newPendingGovernance?: null,
    ): TypedEventFilter<[string, string], { oldPendingGovernance: string; newPendingGovernance: string }>;
  ...
  estimateGas: {
    ...
    creditPools(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    creditPools(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
