...
interface RegistryStorageV1V1Interface extends ethers.utils.Interface {
  functions: {
...
export class RegistryStorageV1V1 extends BaseContract {
  ...
  interface: RegistryStorageV1V1Interface;
