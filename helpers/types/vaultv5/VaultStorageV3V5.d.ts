...
interface VaultStorageV3V5Interface extends ethers.utils.Interface {
  functions: {
...
export class VaultStorageV3V5 extends BaseContract {
  ...
  interface: VaultStorageV3V5Interface;
