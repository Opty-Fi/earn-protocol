...
interface VaultStorageV2V5Interface extends ethers.utils.Interface {
  functions: {
...
export class VaultStorageV2V5 extends BaseContract {
  ...
  interface: VaultStorageV2V5Interface;
