...
import type { VaultStorageV3V5, VaultStorageV3V5Interface } from "../VaultStorageV3V5";
...
export class VaultStorageV3V5__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<VaultStorageV3V5> {
    return super.deploy(overrides || {}) as Promise<VaultStorageV3V5>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): VaultStorageV3V5 {
    return super.attach(address) as VaultStorageV3V5;
  }
  connect(signer: Signer): VaultStorageV3V5__factory {
    return super.connect(signer) as VaultStorageV3V5__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VaultStorageV3V5Interface {
    return new utils.Interface(_abi) as VaultStorageV3V5Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VaultStorageV3V5 {
    return new Contract(address, _abi, signerOrProvider) as VaultStorageV3V5;
  }
}
