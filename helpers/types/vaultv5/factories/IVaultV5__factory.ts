...
import type { IVaultV5, IVaultV5Interface } from "../IVaultV5";
...
export class IVaultV5__factory {
  static readonly abi = _abi;
  static createInterface(): IVaultV5Interface {
    return new utils.Interface(_abi) as IVaultV5Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IVaultV5 {
    return new Contract(address, _abi, signerOrProvider) as IVaultV5;
  }
}
