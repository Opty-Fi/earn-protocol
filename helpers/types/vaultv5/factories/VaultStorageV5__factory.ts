...
import type { VaultStorageV5, VaultStorageV5Interface } from "../VaultStorageV5";
...
export class VaultStorageV5__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<VaultStorageV5> {
    return super.deploy(overrides || {}) as Promise<VaultStorageV5>;
  }
  getDeployTransaction(overrides?: Overrides & { from?: string | Promise<string> }): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): VaultStorageV5 {
    return super.attach(address) as VaultStorageV5;
  }
  connect(signer: Signer): VaultStorageV5__factory {
    return super.connect(signer) as VaultStorageV5__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VaultStorageV5Interface {
    return new utils.Interface(_abi) as VaultStorageV5Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VaultStorageV5 {
    return new Contract(address, _abi, signerOrProvider) as VaultStorageV5;
  }
}
