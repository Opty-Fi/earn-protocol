    ...
    proxy: {
      ...
      execute: {
        init: {
          ...
          args: [registryProxyAddress, MULTI_CHAIN_VAULT_TOKENS[chainId].WETH.hash, "Wrapped ETH", "WETH.e", "1"],
        },
      },
    },
    ...
    if (result.newlyDeployed) {
      ...
      if (networkName === "tenderly") {
        await tenderly.verify({
          ...
          constructorArguments: [registryProxyAddress, "Wrapped ETH", "WETH.e", "Growth", "grow"],
        });
