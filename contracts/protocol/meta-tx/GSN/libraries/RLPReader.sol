...
library RLPReader {
    ...
    function decodeLegacyTransaction(bytes calldata rawTransaction)
        internal
        pure
        returns (
            uint256,
     ...
     * @return tuple (nonce,gasLimit,to,value,data)
     */
    function decodeTransactionType1(bytes calldata rawTransaction)
        internal
        pure
        returns (
            uint256,
     ...
     * @return tuple (nonce,gasLimit,to,value,data)
     */
    function decodeTransactionType2(bytes calldata rawTransaction)
        internal
        pure
        returns (
            uint256,
