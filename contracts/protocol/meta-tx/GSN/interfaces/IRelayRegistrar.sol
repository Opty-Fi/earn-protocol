...
import "@openzeppelin/contracts-0.8.x/interfaces/IERC165.sol";
...
interface IRelayRegistrar is IERC165 {
     ...
     */
    event RelayServerRegistered(address indexed relayManager, address indexed relayHub, bytes32[3] relayUrl);
     ...
     */
    function registerRelayServer(address relayHub, bytes32[3] calldata url) external;
     ...
     */
    function readRelayInfos(address relayHub) external view returns (RelayInfo[] memory info);
