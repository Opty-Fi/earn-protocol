 ...
 */
contract OPTYStakingPool60Days is ERC20, Modifiers, ReentrancyGuard, StakingPoolStorage {
    using SafeERC20 for IERC20;
    using Address for address;

    uint256 public constant timelockPeriod = uint256(5184000);
    ...
    constructor(
        ...
        public
        ERC20(
            string(abi.encodePacked("op ", "60 Days", " Staking", " Pool")),
            string(abi.encodePacked("op", "60Days", "StkPool"))
        )
        Modifiers(_registry)
    {
