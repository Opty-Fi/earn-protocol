...
contract FulcrumCodeprovider is ICodeProvider {
    ...
    function getWithdrawCodes(address _optyPool, address[] memory _underlyingTokens, address _liquidityPool , uint _burnAmount) public override view returns(bytes[] memory _codes) {
        _codes = new bytes[](1);
