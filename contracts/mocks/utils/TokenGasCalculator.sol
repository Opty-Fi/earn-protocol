...
contract TokenGasCalculator is RelayHub, AllEvents {
    ...
    function calculatePostGas(
        ...
        GsnTypes.RelayData memory relayData =
            GsnTypes.RelayData(1, 1, 0, address(0), address(0), address(0), paymasterData, 0);

        //with precharge
        uint256 gas0 = gasleft();
        paymaster.postRelayedCall(ctx1, true, 1000000000000000, relayData);
