...
interface IVault {
     ...
     * @return The unclaimed unclaimed vault's balance of claimed reward tokens of a given liquidity pool.
     */
    function balanceUnclaimedUnclaimedClaimedRewardToken(address _liquidityPool) external view returns (uint256);
